...
object Anagrams {
  ...
  def sentenceOccurrences(s: Sentence): Occurrences = {
    val ws:Word = s.flatten.toString
    val filteredWords:Word = ws filter (ch => ch.isLetter)
    //filteredSentence flatMap wordOccurrences
    val mapping:Map[Char, String] = filteredWords groupBy (x => x.toLower)
