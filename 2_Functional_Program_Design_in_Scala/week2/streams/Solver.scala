...
trait Solver extends GameDef {
  ...
  def from(initial: Stream[(Block, List[Move])],
    ...
    if (initial.isEmpty) Stream.empty
      ...
      val headNeigh = newNeighborsOnly(neighbors, explored)

      val tailNeigh = from(headNeigh #::: initial.tail, explored + head._1)
      ...
      val more = tail #::: headNeigh

      head #:: from(more, explored + head._1)
    }
  }
